...
def page_project_summary_body():
    ...
    st.write(
        ...
        f"[Project README file](https://github.com/SamMartin92/milestone" +
        f"-project-heritage-housing-issues).")
...
html_string = """<details>
                ...
                <td style="text-align:left">Bedrooms above grade (does NOT
                include basement bedrooms)</td>
                <td style="text-align:left">0 - 8</td>
                </tr>
                <tr>
                <td style="text-align:left">BsmtExposure</td>
                <td style="text-align:left">Refers to walkout or garden level
                walls</td>
                <td style="text-align:left">Gd: Good Exposure; Av: Average
                Exposure; Mn: Mimimum Exposure; No: No Exposure; None:
                No Basement</td>
                </tr>
                <tr>
                <td style="text-align:left">BsmtFinType1</td>
                <td style="text-align:left">Rating of basement finished
                area</td>
                <td style="text-align:left">GLQ: Good Living Quarters;
                ALQ: Average Living Quarters;
                BLQ: Below Average Living Quarters; Rec: Average Rec Room;
                LwQ: Low Quality; Unf: Unfinshed; None: No Basement</td>
                </tr>
                <tr>
                ...
                <td style="text-align:left">Unfinished square feet of basement
                area</td>
                <td style="text-align:left">0 - 2336</td>
                </tr>
                <tr>
                <td style="text-align:left">TotalBsmtSF</td>
                <td style="text-align:left">Total square feet of basement
                area</td>
                ...
                <td style="text-align:left">Fin: Finished; RFn: Rough Finished;
                Unf: Unfinished; None: No Garage</td>
                </tr>
                <tr>
                ...
                <td style="text-align:left">Above grade (ground) living area
                square feet</td>
                ...
                <td style="text-align:left">Ex: Excellent; Gd: Good; TA:
                Typical/Average; Fa: Fair; Po: Poor</td>
                </tr>
                <tr>
                ...
                <td style="text-align:left">Linear feet of street connected
                to property</td>
                <td style="text-align:left">21 - 313</td>
                </tr>
                <tr>
                <td style="text-align:left">MasVnrArea</td>
                <td style="text-align:left">Masonry veneer area in square
                feet</td>
                <td style="text-align:left">0 - 1600</td>
                </tr>
                <tr>
                <td style="text-align:left">EnclosedPorch</td>
                <td style="text-align:left">Enclosed porch area in square
                feet</td>
                ...
                <td style="text-align:left">Rates the overall condition of the
                house</td>
                <td style="text-align:left">10: Very Excellent; 9: Excellent;
                8: Very Good; 7: Good; 6: Above Average; 5: Average; 4: Below
                Average; 3: Fair; 2: Poor; 1: Very Poor</td>
                </tr>
                <tr>
                <td style="text-align:left">OverallQual</td>
                <td style="text-align:left">Rates the overall material and
                finish of the house</td>
                <td style="text-align:left">10: Very Excellent; 9: Excellent;
                8: Very Good; 7: Good; 6: Above Average; 5: Average;
                4: Below Average; 3: Fair; 2: Poor; 1: Very Poor</td>
                </tr>
                <tr>
                ...
                <td style="text-align:left">Remodel date (same as construction
                date if no remodeling or additions)</td>
